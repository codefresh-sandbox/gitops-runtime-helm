...
![Version: 1.3.0](https://img.shields.io/badge/Version-1.3.0-informational?style=flat-square) ![AppVersion: 0.1.53](https://img.shields.io/badge/AppVersion-0.1.53-informational?style=flat-square)
...
```
docker run -v <output_dir>:/output quay.io/codefresh/gitops-runtime-private-registry-utils:1.3.0 <local_registry>
```
